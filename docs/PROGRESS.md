...
### 2026-01-31 (深夜 - OpenList 集成)

- ✅ 集成 WebDAV 客户端访问 OpenList
- ✅ 创建 webdav.service.ts 服务层
- ✅ 创建文件上传路由 (upload.routes.ts)
- ✅ 支持单文件和批量文件上传
- ✅ 创建前端文件上传组件 (FileUpload.tsx)
- ✅ 素材管理页面集成文件上传功能
- ✅ 添加 .env.example 环境变量配置示例

### 2026-01-31 (深夜 - 搜索筛选功能)

- ✅ 创建高级搜索筛选组件 (SearchFilter)
- ✅ 支持按标签筛选素材
- ✅ 后端添加 tagId 筛选参数
- ✅ 添加热门素材和最新素材 API
- ✅ 首页添加热门下载展示区域
...
- ✅ 添加图片预览灯箱组件 (ImageLightbox)
- ✅ 支持键盘快捷键 (ESC关闭, +/-缩放)
- ✅ 添加主题切换功能 (浅色/深色/跟随系统)
- ✅ 创建 ThemeContext 主题上下文
- ✅ 创建 ThemeToggle 主题切换组件
- ✅ 在所有公共页面添加主题切换按钮
- ✅ 添加响应式布局支持
- ✅ 创建移动端菜单组件 (MobileMenu)
- ✅ 添加全局响应式样式和动画
- ✅ 完善亮色/暗色主题适配
- ✅ 定义完整的主题颜色系统 (AppColors)
- ✅ 首页、游戏页、素材详情页全面主题适配
